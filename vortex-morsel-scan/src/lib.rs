...
//! Selection and construction facade for the experimental push scan executor.
//!
//! SQL integrations use this crate to select between V1 and physical push pipelines.
...
impl ScanExecutorOptions {
    /// Set the number of workers used by the morsel implementation.
...
mod tests {
    ...
    fn parses_stable_backend_labels() -> VortexResult<()> {
        ...
        assert!(ScanBackend::from_str("pull").is_err());
