...
| `onpair_kernel.wasm` | `encodings/onpair/wasm` | `vortex.onpair` |
...
(cd encodings/onpair/wasm && cargo build --target wasm32-unknown-unknown --release)
...
cp encodings/onpair/wasm/target/wasm32-unknown-unknown/release/vortex_onpair_wasm.wasm \
